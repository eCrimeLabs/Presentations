...
sub ElasticSearchGetData {
   ...
   if ($tier == 0){
      ...
      while (my ($key, $value) = each %{ $osint{"tier1"} } ) {
         ...
         $output .= "]}";
         $output =~ s/\[,/\[/;
         $output =~ s/"_type":"event",/"_tier":"1",/g;
      ...
      while (my ($key, $value) = each %{ $osint{"tier2"} } ) {
         ...
         $output .= "]}";
         $output =~ s/\[,/\[/;
         $output =~ s/"_type":"event",/"_tier":"2",/g;
         $output =~ s/"_type"/"_tier"/g;
         $output =~ s/"event"/"2"/g;
         push (@elk_arr, $output);
         # -------------------------
      ...
      while (my ($key, $value) = each %{ $osint{"tier3"} } ) {
         my $match  = '{"match":{"dst_whois.number":"' . $key . '"}}';
         my $output = '';
         my $full_query = $elk_header . $match . $elk_footer;
         ...
         $output .= "]}";
         $output =~ s/\[,/\[/;
         $output =~ s/"_type":"event",/"_tier":"3",/g;
         $output =~ s/"_type"/"_tier"/g;
         $output =~ s/"event"/"3"/g;         
         push (@elk_arr, $output);
         # -------------------------
      ...
      while (my ($key, $value) = each %{ $osint{"tier4"} } ) {
         ...
         $output .= "]}";
         $output =~ s/\[,/\[/;
         $output =~ s/"_type":"event",/"_tier":"4",/g;
         $output =~ s/"_type"/"_tier"/g;
         $output =~ s/"event"/"4"/g;         
         push (@elk_arr, $output);
         # -------------------------
      ...
      while (my ($key, $value) = each %{ $osint{"tier5"} } ) {
         ...
         $output .= "]}";
         $output =~ s/\[,/\[/;
         $output =~ s/"_type":"event",/"_tier":"5",/g;
         $output =~ s/"_type"/"_tier"/g;
         $output =~ s/"event"/"5"/g;         
         push (@elk_arr, $output);
         # -------------------------
      ...
      while (my ($key, $value) = each %{ $osint{"tier5"} } ) {
         ...
         $output .= "]}";
         $output =~ s/\[,/\[/;
         $output =~ s/"_type":"event",/"_tier":"6",/g;
         $output =~ s/"_type"/"_tier"/g;
         $output =~ s/"event"/"6"/g;         
         push (@elk_arr, $output);
         # -------------------------
